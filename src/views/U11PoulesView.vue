<template>
      <v-card class="mx-auto">
        <v-tabs color="primary accent-4" left>
          <v-tab >U11 Poule A</v-tab>
          <v-tab >U11 Poule B</v-tab>
            ...
            <v-row>
              <v-col>
                <base-material-card color="colorPA" class="px-0"  >
                  ...
                  <div class="display-2 font-weight-light">U11 - PouleA - Matchs</div>
                  </template>
              ...
              <v-col>
                <base-material-card color="colorPA" class="px-0"  >
                  <template v-slot:heading>
                      <div class="display-2 font-weight-light">U11 - PouleA - Classement</div>
                  </template>
                  <v-card-text class="px-0" >
              ...
              <v-row>
                  <v-col>
                      <base-material-card color="colorPB" class="px-0"  >
                          <template v-slot:heading>
                              <div class="display-2 font-weight-light">U11 - PouleB - Matchs</div>
                          </template>
                          <v-card-text class="px-0" >
                  ...
                  <v-col>
                    <base-material-card color="colorPB" class="px-0"  >
                        <template v-slot:heading>
                            <div class="display-2 font-weight-light">U11 - PouleB - Classement</div>
                        </template>
                        <v-card-text class="px-0" >
